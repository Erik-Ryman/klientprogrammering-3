...
const RegisterForm: NextPage = () => {
	...
	const handleaboutCompanyChange = (e: React.ChangeEvent<HTMLInputElement>) => {
		setRegisterData({ ...registerData, aboutCompany: e.target.value });
	};
	...
	return (
		<div className='min-h-screen bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			<div className='sm:mx-auto sm:w-full sm:max-w-md'>
				<h2 className='text-center text-3xl font-extrabold text-white'>Sign up as a company</h2>
			</div>
			...
			<div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
				<div className='bg-gray-800 py-8 px-6 shadow-md sm:rounded-lg sm:px-10'>
					<form onSubmit={handleSubmit} className='space-y-6'>
						...
						<div>
							<label htmlFor='aboutCompany' className='block text-sm font-medium text-white'>
								About your company
							</label>
							<div className='mt-1'>
								<input
